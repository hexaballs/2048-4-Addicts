...
(function() {
  var boardIsFull, buildBoard, collapseCells, generateTile, getCol, getRow, isGameOver, mergeCells, move, moveIsValid, noValidMoves, printArray, randomCellIndices, randomInt, randomValue, score, setCol, setRow, showBoard,
  ...
  $(function() {
    ...
    setInterval((function(_this) {
      return function() {
        if ((timePlayedSec === 1) && (timePlayedMin === 0)) {
      ...
      return function(e) {
        ...
        if (__indexOf.call(keys, key) >= 0) {
          ...
          if (moveIsValid(_this.board, newBoard)) {
            ...
            $('.score > p').html(score(_this.board));
            generateTile(_this.board);
